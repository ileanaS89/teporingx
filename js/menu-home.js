document.getElementById('menu').innerHTML='<nav id="menuBarra">'
+'<div class="search">'
+'<div class="menubar">'
...
+'<li class="redesLink"><a class="linkFooter"><i class="fa fw-fa fa-instagram"></i></a></li>'
+'<li class="redesLink"><a class="linkFooter"><i class="fa fw-fa fa-facebook"></i></a></li>'
+'<li class="redesLink"><a class="linkFooter"><i class="fa fw-fa fa-youtube"></i></a></li>'
